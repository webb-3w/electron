...
module.exports = {
  ...
  sourceOverload: function(...args) {
    return binding.sourceOverload.apply(binding, args)
  },

  setCompanyInfo: function (...args) {
    return binding.setCompanyInfo.apply(binding, args)
  },
